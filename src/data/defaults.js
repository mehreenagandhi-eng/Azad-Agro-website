...
export const DEFAULT_MARKETPLACE = {
  ...
  buyerSteps: [
    ...
    "Add their products to your crate and check out — you can mix products from multiple manufacturers in one order",
  ],
  ...
  manufacturerSteps: [
    ...
    "Add your products with photos, prices, and units so buyers can start ordering",
  ...
  copy: {
    ...
    totalLabel: "Total",
    freeLabel: "Free",
    proceedCheckoutLabel: "Proceed to checkout →",
    ...
    confirmHeading: "Your crate is being packed.",
